...
SilphWomanSprite:     INCBIN "gfx/sprites/silph_woman.2bpp"
...
TradingAnimationGraphics:
	INCBIN "gfx/trade/game_boy.norepeat.2bpp"
	INCBIN "gfx/trade/link_cable.2bpp"
TradingAnimationGraphicsEnd:

TradingAnimationGraphics2:
; Pokeball traveling through the link cable.
	INCBIN "gfx/trade/trade2.2bpp"
TradingAnimationGraphics2End:

TradeBubbleGFX: 
	INCBIN "gfx/trade/bubble.2bpp"
TradBubbleGFXEnd:
...
UnownPicFront::		  INCBIN "pic/bmon/unown_a.pic"
UnownPicBack::		  INCBIN "pic/monback/unown_a_b.pic"
...
SECTION "bank2F",ROMX,BANK[$3E] ;temporary space for SGB code
INCLUDE "engine/sgb.asm"
INCLUDE "engine/color.asm"

SECTION "bank3F", ROMX,BANK[$3F]
;INCLUDE "data/map_header_pointers.asm" ;Moved code out of home

BillSprite:			   INCBIN "gfx/sprites/green/bill.2bpp"
BlaineSprite:		   INCBIN "gfx/sprites/green/blaine.2bpp"
BrockSprite:		   INCBIN "gfx/sprites/green/brock.2bpp"
MistySprite:		   INCBIN "gfx/sprites/green/misty.2bpp"
LtSurgeSprite:		   INCBIN "gfx/sprites/green/surge.2bpp"
ErikaSprite:		   INCBIN "gfx/sprites/green/erika.2bpp"
KogaSprite:			   INCBIN "gfx/sprites/green/koga.2bpp"
SabrinaSprite:		   INCBIN "gfx/sprites/green/sabrina.2bpp"
GuitaristSprite:	   INCBIN "gfx/sprites/green/guitarist.2bpp"
SwimmerFSprite:		   INCBIN "gfx/sprites/green/swimmer_2.2bpp"
SnorlaxBigSprite:	   INCBIN "gfx/sprites/green/snorlax_big.2bpp"
SurfingPikachuSprite:  INCBIN "gfx/sprites/green/surfing_pikachu.2bpp"
RocketFSprite:		   INCBIN "gfx/sprites/green/rocket_2.2bpp"
KimonoGirlSprite:	   INCBIN "gfx/sprites/green/kimono_girl.2bpp"
ClerkSprite:    	   INCBIN "gfx/sprites/green/clerk.2bpp"
SlowpokeSprite:		   INCBIN "gfx/sprites/green/slowpoke_ow.2bpp"
PikachuSprite:         INCBIN "gfx/sprites/green/pikachu_ow.2bpp"
JigglypuffSprite:      INCBIN "gfx/sprites/green/jigglypuff_ow.2bpp"
ChanseySprite:         INCBIN "gfx/sprites/green/chansey_ow.2bpp"
LaprasSprite:          INCBIN "gfx/sprites/green/surfing_lapras.2bpp"
CelioSprite:		   INCBIN "gfx/sprites/green/celio.2bpp"
RockSmashSprite:	   INCBIN "gfx/sprites/green/rocksmash.2bpp"
