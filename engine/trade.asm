...
Trade_LoadMonPartySpriteGfx:
	ld a, %11010000 ;Change to something else...
	ld [rOBP1], a
	jpba Trade_LoadMonIconGFX
...
LoadCircleGFX:
	...
	lb bc, BANK(TradeBubbleGFX), $8
	call CopyVideoData
	ret
	
Trade_WriteCircledMonOAM:
	callba WriteTradeMonOAM
...
LoadTradeBubbleGFX: ; 2985a
	call DelayFrame
	callab LoadPartyMonSprites ;trade mon pic
	ld de, TradeBubbleGFX
	ld hl, Trade_CircleOAMPointers
