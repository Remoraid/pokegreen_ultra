...
SetPal_Battle:
	...
	ld hl, PalPacket_Unk1
	ld de, wSGBPals + $10
	ld bc, $10
	call CopyData
	
	call GetBattlemonBackpicPalettePointer ;Function9ba9
	...
	ld a, [hl]
	ld [wSGBPals + $16], a
	call GetEnemyFrontpicPalettePointer ;Function9bba
	ld a, [hli]
	ld [wSGBPals + $19], a
	ld a, [hli]
	ld [wSGBPals + $1a], a
...
SetPal_StatusScreen:
	...
	ld bc, $10
	call CopyData
	ld a, [wStatusScreenHPBarColor] ;wcda1 ????
	ld l, a
	ld h, 0
	add hl, hl
	add hl, hl
...
SetPal_TradeTube: ; 89d9
	ld hl, PalPacket_TradeTube
	ld de, BlkPacket_TradeTube
	ret
...
INCLUDE "pic/palettes/bmon/palette_pointers.asm"

INCLUDE "pic/palettes/trainer/palette_pointers.asm"
